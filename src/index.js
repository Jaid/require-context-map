 ...
 * @example
 * import requireContextMap from "require-context-map"
 * requireContextMap(["a", "b"])
 * // {a: null, b: null}
 * @example
 * import requireContextMap from "require-context-map"
 * requireContextMap(["a", "b"], "value")
 * // {a: "value", b: "value"}
 * @example
 * import requireContextMap from "require-context-map"
 * requireContextMap(["a", "b"], (key, index) => `value for ${key} #${index + 1}`)
